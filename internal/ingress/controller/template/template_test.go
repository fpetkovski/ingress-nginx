...
func TestBuildPluginConfigForLua(t *testing.T) {
	...
	cases := []testCase{
		{"hi=mom;", `{
	plugin_magellan_endpoint = "http://magellan:8080",
	plugin_magellan_keepalive_pool_size = 100,
	plugin_magellan_keepalive_timeout = 5000,
	plugin_magellan_service_identifier = "nginx",
	plugin_magellan_timer_poll_interval = 1,
	plugin_open_telemetry_add_cloudflare_span = false,
	...
	plugin_open_telemetry_bypassed_upstreams = "all",
