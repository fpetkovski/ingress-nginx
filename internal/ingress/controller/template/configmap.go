...
const (
	...
	otelSendTraceResponse                 = "plugin-opentelemetry-send-traceresponse"
	...
	otelBspBatchTimeout                   = "plugin-opentelemetry-bsp-batch-timeout"
	otelBspExportTimeout                  = "plugin-opentelemetry-bsp-export-timeout"
	otelExporterOtlpHeaders               = "plugin-opentelemetry-exporter-otlp-headers"
	otelInactiveTimeout                   = "plugin-opentelemetry-inactive-timeout"
